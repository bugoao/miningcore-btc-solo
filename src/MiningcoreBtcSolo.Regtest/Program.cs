...
static void EnsureBitcoind(ref Process? bitcoind, string datadir, string rpcUrl, string user, string pass)
{
    ...
    bitcoind = Process.Start(new ProcessStartInfo
    {
        ...
        Arguments = $"-datadir=\"{datadir}\" -regtest -server=1 -txindex=1 -rpcuser={user} -rpcpassword={pass} -rpcport=18443 -rpcallowip=127.0.0.1 -rpcbind=127.0.0.1 -bind=127.0.0.1:18444 -discover=0 -dnsseed=0 -fixedseeds=0 -natpmp=0 -fallbackfee=0.0002 -acceptnonstdtxn=1 -zmqpubhashblock=tcp://127.0.0.1:28332 -zmqpubrawblock=tcp://127.0.0.1:28333",
        UseShellExecute = false,
        RedirectStandardOutput = true,
        RedirectStandardError = true
